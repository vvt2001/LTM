	...
	while (1) {
		...
		while (checkLogin == false) {
			...
			if (messageLen == 0) {
				...
				else if (strcmp(buff, "1") == 0) { //if logged in, break while
					printf("Login successfully\n\n");
					checkLogin = true;
					break;
				}
				else if (strcmp(buff, "-1") == 0) printf("Username incorrect! Try again!\n\n");
				else if (strcmp(buff, "0") == 0) printf("Username locked! Try another one!\n\n");
			}//end while login
		}
